...
/*    */   
/* 17 */   public void setCriterias(List<SearchCriteria> criterias) { this.criterias = criterias; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof RolesSpecification)) return false;  RolesSpecification other = (RolesSpecification)o; if (!other.canEqual(this)) return false;  Object<SearchCriteria> this$criterias = (Object<SearchCriteria>)getCriterias(), other$criterias = (Object<SearchCriteria>)other.getCriterias(); return !((this$criterias == null) ? (other$criterias != null) : !this$criterias.equals(other$criterias)); } protected boolean canEqual(Object other) { return other instanceof RolesSpecification; } public int hashCode() { int PRIME = 59; result = 1; Object<SearchCriteria> $criterias = (Object<SearchCriteria>)getCriterias(); return result * 59 + (($criterias == null) ? 43 : $criterias.hashCode()); } public String toString() { return "RolesSpecification(criterias=" + getCriterias() + ")"; } public RolesSpecification(List<SearchCriteria> criterias) {
...
/* Location:              C:\Users\Administrator\Desktop\!\nencer\app\Modules\Users\Repository\specifications\RolesSpecification.class
