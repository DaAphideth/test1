...
/*    */ 
/*    */ public class PermissionsSpecification implements Specification<Permissions> {
/*    */   private List<SearchCriteria> criterias;
/*    */   
/* 17 */   public void setCriterias(List<SearchCriteria> criterias) { this.criterias = criterias; } public boolean equals(Object o) { if (o == this) return true;  if (!(o instanceof PermissionsSpecification)) return false;  PermissionsSpecification other = (PermissionsSpecification)o; if (!other.canEqual(this)) return false;  Object<SearchCriteria> this$criterias = (Object<SearchCriteria>)getCriterias(), other$criterias = (Object<SearchCriteria>)other.getCriterias(); return !((this$criterias == null) ? (other$criterias != null) : !this$criterias.equals(other$criterias)); } protected boolean canEqual(Object other) { return other instanceof PermissionsSpecification; } public int hashCode() { int PRIME = 59; result = 1; Object<SearchCriteria> $criterias = (Object<SearchCriteria>)getCriterias(); return result * 59 + (($criterias == null) ? 43 : $criterias.hashCode()); } public String toString() { return "PermissionsSpecification(criterias=" + getCriterias() + ")"; } public PermissionsSpecification(List<SearchCriteria> criterias) {
...
/*    */ 
/*    */   
/*    */   public Predicate toPredicate(Root<Permissions> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
...
/* Location:              C:\Users\Administrator\Desktop\!\nencer\app\Modules\Users\Repository\specifications\PermissionsSpecification.class
